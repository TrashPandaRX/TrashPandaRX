...
# trying to fix samplePt3.py's shitty graphs
import scipy as sp
import numpy as np
...
fb5 = np.poly1d(np.polyfit(xb, yb, 5))  # added this one myself
...
'''fb1, fb2, fb3, fb10, fb100'''
plot_web_traffic(x, y, [fb100], mx, ymax) #-- temp removal lets you clearly see the scattered points again, or removal of fb's lets you see individual plots of higher degrees
'''
...
# useful to set limits of the graph so i dont lose the actual data plots
#plt.xlim([3,4])
#plt.ylim([0,6000])
