...
MAX has since been moved to the beginning of the for loop
'''
temp = 200		# testing 100 first, then 150, then 200
...
def tempCoolant(temp, tCounter):
	return (temp - (tCounter/10))	# *the number that tCounter is being modified by is subject to CHANGE
